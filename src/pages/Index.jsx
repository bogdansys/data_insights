...
const Index = () => {
  ...
  return (
    <div
      className={`min-h-screen ${darkMode ? "dark bg-gradient-to-br from-gray-900 to-gray-800" : "bg-gradient-to-br from-blue-50 to-indigo-100"}`}
    >
            ...
            <CardContent className="p-6">
              <Tabs defaultValue="upload" className="w-full">
                <TabsList className="grid w-full grid-cols-4 mb-8 gap-2">
                  {["upload", "analysis", "visualization", "ml"].map(
                    (value, index) => (
      ...
      <footer
        className={`${darkMode ? "bg-gray-800" : "bg-white"} shadow-lg mt-12`}
      >
        <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 flex justify-center items-center space-x-6">
          <a
            href="https://www.linkedin.com/in/mihai-iordache-676444187/"
            target="_blank"
          ...
          <a
            href="https://github.com/bogdansys"
            target="_blank"
            rel="noopener noreferrer"
          ...
          <a
            href="mailto:bogdanmihai453@gmail.com"
